...
import '../../features/player/data/remote_auth_data_source.dart';
...
Future<void> setupServiceLocator() async {
  ...
  sl
    ...
    ..registerLazySingleton<SessionStore>(
      () => SessionStore(box: playerBox, tokenStore: sl<AuthTokenStore>()),
    )
  ...
  // --- Auth (needs the AOP-decorated IProgressRepository for migration) ---
  sl
    ..registerLazySingleton<RemoteAuthDataSource>(RemoteAuthDataSource.new)
    ..registerFactory<AuthCubit>(
      () => AuthCubit(
        remoteAuth: sl<RemoteAuthDataSource>(),
        sessionStore: sl<SessionStore>(),
        progressRepo: sl<IProgressRepository>(),
      ),
    );
