...
static final LevelModel level1Heart = LevelModel(
    ...
    boardState: BoardStateModel(arrows: [
      arrowHelper('a1', 'left', [[0, 2], [0, 1]]),
      arrowHelper('a2', 'right', [[0, 4], [0, 5]]),
      arrowHelper('a3', 'left', [[1, 2], [1, 1], [1, 0]]),
      arrowHelper('a4', 'down', [[1, 3]]),
      arrowHelper('a5', 'right', [[1, 4], [1, 5], [1, 6]]),
      arrowHelper('a6', 'left', [[2, 2], [2, 1], [2, 0]]),
      arrowHelper('a7', 'down', [[2, 3]]),
      arrowHelper('a8', 'right', [[2, 4], [2, 5], [2, 6]]),
      arrowHelper('a9', 'left', [[3, 3], [3, 2], [3, 1]]),
      arrowHelper('a10', 'right', [[3, 4], [3, 5]]),
