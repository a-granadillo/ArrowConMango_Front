...
@injectable
class HexMyLevelsCubit extends Cubit<HexCreativeListState> {
  HexMyLevelsCubit(this._repository) : super(const HexCreativeListLoading());

  final IHexCreativeLevelRepository _repository;

  Future<void> load() async {
    emit(const HexCreativeListLoading());
    final result = await _repository.getMyLevels();
    switch (result) {
